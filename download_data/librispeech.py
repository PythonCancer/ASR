...
URL_TEST_CLEAN = f"{URL_ROOT}/test-clean.tar.gz"
URL_TEST_OTHER = f"{URL_ROOT}/test-other.tar.gz"
URL_DEV_CLEAN = f"{URL_ROOT}/dev-clean.tar.gz"
URL_DEV_OTHER = f"{URL_ROOT}/dev-other.tar.gz"
URL_TRAIN_CLEAN_100 = f"{URL_ROOT}/train-clean-100.tar.gz"
URL_TRAIN_CLEAN_360 = f"{URL_ROOT}/train-clean-360.tar.gz"
URL_TRAIN_OTHER_500 = f"{URL_ROOT}/train-other-500.tar.gz"
